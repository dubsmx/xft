...
const steps = [
  {
    ...
    icon: <UserPlus size={64} className="text-white" strokeWidth={1.5} />
  },
  {
    id: 2,
    title: "Cotiza",
    ...
    icon: <Search size={64} className="text-white" strokeWidth={1.5} />
  },
  {
    id: 3,
    title: "Elige y Paga",
    ...
    icon: <CreditCard size={64} className="text-white" strokeWidth={1.5} />
  },
  {
    id: 4,
    ...
    icon: <Truck size={64} className="text-white" strokeWidth={1.5} />
  }
];
    ...
    <section className="py-20 bg-white overflow-hidden relative">
      <div className="max-w-[1200px] mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative flex justify-center items-center h-[400px]">
            <AnimatePresence mode="wait">
                ...
                >
                    ...
                    {/* Capa 1: Velocidad Alta - Colores Vivos */}
                    <motion.div 
                        ...
                        animate={{ rotate: 360 }}
                        transition={{ duration: 2, repeat: Infinity, ease: "linear" }} // 2 segundos por vuelta (Rápido)
                    />
                    
                    {/* Capa 2: Contrapeso para mezclar colores */}
                    <motion.div 
                    ...
                    {/* CONTENEDOR DEL ICONO (Sólido Morado) */}
          ...
          {/* LADO DERECHO: CONTENIDO Y BOTONES DE NAVEGACIÓN */}
          <div className="relative flex flex-col justify-center pl-0 md:pl-8">
            
            {/* --- BOTONES DE CONTROL (NUEVOS Y GRANDES) --- */}
            <div className="flex items-center gap-4 mb-8 z-30"> {/* z-30 para asegurar click */}
                <button 
                    onClick={prevStep} 
            ...
            <AnimatePresence mode="wait">
                <motion.div
                    ...
                    exit={{ opacity: 0, x: -50 }}
                    transition={{ duration: 0.2 }} // Transición rápida de texto
            ...
            {/* Indicadores de Progreso (Puntos abajo) */}
